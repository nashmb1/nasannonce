...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'nas_core_homepage');
            }

            return array (  '_controller' => 'NAS\\CoreBundle\\Controller\\HomeController::indexAction',  '_route' => 'nas_core_homepage',);
        }

        // nas_core_contact
        if ($pathinfo === '/contact') {
            return array (  '_controller' => 'NAS\\CoreBundle\\Controller\\HomeController::contactAction',  '_route' => 'nas_core_contact',);
        }
        ...
        if (0 === strpos($pathinfo, '/platform')) {
            ...
            if ($pathinfo === '/platform/a_faire_plus_tard') {
                return array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::editImageAction',  '_route' => 'oc_platform_edit_image',);
            }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                // login
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'NAS\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'login',);
                }
