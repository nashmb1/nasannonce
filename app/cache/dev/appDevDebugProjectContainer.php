...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'\\src\\OC\\PlatformBundle\\Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'\\src\\NAS\\UserBundle\\Entity')));
    ...
    {
        return $this->services['nas_user.registration.form.type'] = new \NAS\UserBundle\Form\RegistrationFormType('NAS\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views'), 'Swiftmailer');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\NAS\\CoreBundle/Resources/views'), 'NASCore');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'\\src\\NAS\\UserBundle/Resources/views'), 'NASUser');
