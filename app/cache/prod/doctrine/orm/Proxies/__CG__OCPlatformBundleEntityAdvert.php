...
class Advert extends \OC\PlatformBundle\Entity\Advert implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'id', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'date', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'title', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'author', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'content', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'published', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'image', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'categories', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'applications', '' . "\0" . 'OC\\PlatformBundle\\Entity\\Advert' . "\0" . 'slug');
        }
